...
from telethon.errors import AuthKeyDuplicatedError, AuthKeyUnregisteredError, MessageNotModifiedError, FloodWaitError
...
class PriceSyncEngine:
    ...
    async def telegram_call(self, awaitable_factory, operation="Telegram-запрос"):
        ...
        try:
            ...
            except (AuthKeyDuplicatedError, AuthKeyUnregisteredError) as e2:

...
class PriceSyncEngine:
    ...
    async def ensure_navigation(self):
        """
        Навигация идёт в том же порядке, что и блоки.
        Кнопки ведут на конкретные сообщения.
        """
        if not self.bot:
        ...
        try:
            ...
            if nav_id:
                try:
                    ...
                    # message is not modified у Bot API тоже нормальная ситуация.

...
class StateStore:
    ...
    def __init__(self, path, default_interval, database):
        ...
        self.data = {
            ...
            # Additional supplier accounts. Slot 1 is the original HI account.
            # Slots 2/3 are configured from the control bot and sessions live in PostgreSQL.
            "extra_sources": {},
    ...
    def _normalized(self, raw):
        ...
        if not isinstance(result.get("extra_sources"), dict):
